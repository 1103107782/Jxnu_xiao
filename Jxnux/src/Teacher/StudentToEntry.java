...
public class StudentToEntry extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException,IOException {
        ...
        String xq=request.getParameter("sem1");
        session.setAttribute("nowxq",xq);
        String km=request.getParameter("keming1");
        session.setAttribute("nowkm",km);
        ...
        try {
            ...
            session.setAttribute("changstudent",slist);
